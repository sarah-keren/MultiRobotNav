...
boxes = [np.array([  2.0 - 0.0*box_size_cells[1], (-2.0 + 0.5*box_size_cells[0]) , np.pi/2 ]),
         ...
         np.array([  2.0 + 1.5*box_size_cells[1]+0.5*box_size_cells[0], -2.5 , 0.0]),
         ...
         np.array([  (0.0  - 0.5*box_size_cells[0]) ,(-3.0 - 0.5*box_size_cells[1]) ,0.0 ]), # solitary box
         ...
         np.array([ -1.5 , 0.0 - 2.0*box_size_cells[1]-0.5*box_size_cells[0], np.pi/2.0])
...
make_map("lab_complete", h_cells, w_cells, origin_cells, boxes, walls,box_size=box_size, wall_size=wall_size)
